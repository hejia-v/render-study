...
namespace xgame
{
	...
	public class CameraController : MonoBehaviour
	{
		...
		void mouseEvent()
		{
			...
			if (Input.GetMouseButtonDown((int)MouseButtonDown1.MBD_LEFT) ||
				Input.GetMouseButtonDown((int)MouseButtonDown1.MBD_MIDDLE) ||
				Input.GetMouseButtonDown((int)MouseButtonDown1.MBD_RIGHT))
